    ...
    return (<div>
        ...
        <div id="content-panel">
            <ImagedTitledP title={"Entretien"} imageSrc={"../public/image/photo-entretien.jpg"} imageAlt={"Chat Ragdoll"}>
                <p>{"Avec un pelage mi-long et un sous-poil modérément dense, le Ragdoll n'exige pas un entretien fastidieux. Un brossage régulier permet de maintenir la beauté et la propreté de son pelage, ainsi que la bonne santé de sa peau. Comme le Ragdoll ne sort pas souvent, il a moins d'occasions de se salir."}<br/><br/>{"Il est recommandé de brosser le Ragdoll une à deux fois par semaine pour l'aider à se débarrasser de ses poils morts, ce qui évite qu'ils s'accumulent dans son intestin et forment des trichobézoards. Lors du brossage, il est important de porter une attention particulière à la zone du \"pantalon\" située sur l'arrière-train du chat, où le poil est généralement plus dense et fourni. De temps en temps, le Ragdoll peut également avoir besoin d'un bain. Les soins dentaires sont indispensables pour prévenir les maladies parodontales causées par le tartre, et il est également nécessaire de couper régulièrement ses griffes, car il les use très lentement."}</p>
            </ImagedTitledP>
            <hr/>
            <div className="row">
