...
export default function SignUp (){
    // placeholder email, placeholder password and button in Json
    const [contentSignUp, setContentSignUp] = useState({});


    useEffect(() => {
        setContentSignUp(signUpData);
    },[]);
                                ...
                                <form action="" method="post" onSubmit={validateAndSubmitForm}>
                                    <div>
                                        <div className="box d-flex">
                                            ...
                                            <input type="email" className="form-control" value={values.email} onChange={setEmail} id="email" placeholder={contentSignUp.pEmail} required/>
                                    ...
                                    <div className="box d-flex">
                                        ...
                                        <input type="email" className="form-control email" value={values.emailVerif} onChange={setEmailVerif} id="email-verif" placeholder={contentSignUp.pEmailVerif} required/>
                                    ...
                                    <div className="box d-flex">
                                        ...
                                        <input type={passwordVisible ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} className="form-control" id="password" placeholder={contentSignUp.pPassword} required/>
                                    ...
                                    <div className="mb-3 box d-flex">
                                        <label htmlFor="password" className="form-label"/>
                                        <input type={passwordVerifVisible ? 'text' : 'password'} value={passwordVerif} onChange={(e) => setPasswordVerif(e.target.value)} className="form-control" id="password-verif" placeholder={contentSignUp.pPasswordVerif} required/>
                                    ...
                                    <button type="submit" className="btn btn-danger">{contentSignUp.buttonConnection}</button>
                                    </div>
                                </form>
                            </div>
                        </div>
